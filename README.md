...
`seed` is the random seed of this experiment. These three parameters can be configured in the config file. You can refer to `./ROAM/configs/int_glioma_tumor_subtyping.ini`  
